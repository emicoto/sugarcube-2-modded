...
(function () {
  ...
  l10nStrings.errorNonexistentPassage =
    'the passage "{passage}" does not exist'; // NOTE: `passage` is supplied locally
  ...
  l10nStrings._warningIntroLacking =
    "Your browser either lacks or has disabled";
  ...
  l10nStrings.uiBarBackward = "Go backward within the {identity} ";
  l10nStrings.uiBarForward = "Go forward within the {identity} history";
  l10nStrings.uiBarJumpto =
    "Jump to a specific point within the {identity} history";
