		...
		*/
		(() => {
			...
			if (markup) {
				...
				$elems.append('<div id="story-header" class="bar-extend"></div><div id="main"><div id="story" role="main" class="bar-extend"><div id="passages" aria-live="polite"></div></div></div><div id="story-footer" class="bar-extend"></div>');
			}
	...
	*/
	function enginePlay(title, noHistory) {
		...
		if (Config.debug) {
			...
			if (passageBeforeOutput != null) { // lazy equality for null
				debugView = new DebugView(
					document.createDocumentFragment(),
					'special',
					'PassageBefore',
			...
			if (passageAfterOutput != null) { // lazy equality for null
				debugView = new DebugView(
					document.createDocumentFragment(),
					'special',
					'PassageAfter',
