...
var Config = (() => {
   ...
   let _lan = "EN"; // running language of Era
   let _defLan = "EN"; // default language of Era
   let _secLan = "CN"; // secondary language of Era
   let _supportLan = ["EN", "CN"]; // support language of Era
   ...
   let _onEra = false; // if true, then it's mean the era is running
   /*******************************************************************************
		Error Constants.
	*******************************************************************************/
   ...
   return Object.freeze({
      ...
      set secLan(value) {
         _secLan = String(value);
      },

      get supportLan() {
         return _supportLan;
      },
      set supportLan(value) {
         _supportLan = Array(value);
      },
