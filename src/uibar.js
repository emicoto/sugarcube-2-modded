    ...
    const $elems = (() => {
      ...
      return jQuery(document.createDocumentFragment()).append(
        ...
        '<div id="ui-bar" aria-live="polite">' +
          ...
          '<ul id="menu-story"></ul>' +
          '<ul id="menu-core">' +
          `<li id="menu-item-saves"><a tabindex="0">${L10n.get(
            "savesTitle"
          )}</a></li>` +
          `<li id="menu-item-settings"><a tabindex="0">${L10n.get(
            "settingsTitle"
          )}</a></li>` +
          `<li id="menu-item-restart"><a tabindex="0">${L10n.get(
            "restartTitle"
          )}</a></li>` +
          `<li id="menu-item-share"><a tabindex="0">${L10n.get(
            "shareTitle"
          )}</a></li>` +
          "</ul>" +
          "</nav>" +
